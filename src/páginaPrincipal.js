...
var categoria = document.getElementsByName("cate");
var botonEdu = document.getElementsByName("btnEdu")
var botonInfo = document.getElementsByName("btnInfo")
var lineas = document.getElementsByClassName("publicaciones")
var fondo = document.getElementsByClassName("princ")

function cambioDeCategoría(e) {
    e.preventDefault();
    categoria[0].innerHTML = "<FontAwesomeIcon icon={faGraduationCap}/> &nbsp;&nbsp;Educación";
    lineas[0].style.borderColor = "#90E2A1"
    lineas[1].style.borderColor = "#90E2A1"
    fondo[0].style.backgroundColor ="rgba(184, 228, 194, 1)"
    botonEdu[0].style.color="#03630D"
    botonEdu[0].style.backgroundColor="rgba(30, 198, 67, 0.13)"
    botonInfo[0].style.color="rgba(57, 57, 57, 1)"
    botonInfo[0].style.backgroundColor= "rgba(246, 246, 246, 1)"
  }
class pagPrinc extends Component{
    render(){
        return (
            <div className="princ">
                <MyNavBarPrinc/>
                ...
                <div className="row justify-content-left">
                    ...
                    <div className="col col-2 pb-5">
                        <div className="container-fluid misGa ml-3 ">
                            <div className="container misC">    
                                <form>
                                    ...
                                    <button id="btnEdu" onClick={cambioDeCategoría} name="btnEdu" className="btn" ><FontAwesomeIcon icon={faGraduationCap}/> &nbsp;&nbsp;Educación</button>
                        ...
                        <br></br><br></br><br></br>
                        <div className="container-fluid misS1 ml-3">
                            <h1 align="left" className="cat pt-2  pb-2"><img src={require("./components/nena.svg")}width="50" height="50" alt=""></img> &nbsp;&nbsp;&nbsp;&nbsp;Social</h1>
                        </div>
                        <div className="container-fluid misGa1 ml-3">
                            <div className="container misC">
