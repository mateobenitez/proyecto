    ...
    return(
        <div className="acerca"> 
            ...
            <div className="container">
                ...
                <p align="left">El Trastorno del Espectro Autista (TEA) es una condición que dura toda la vida y que altera la capacidad de una persona para comunicarse y relacionarse con otros.<br></br><br></br>
